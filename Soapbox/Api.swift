...
class Api {
    ...
    var BASE_URL: String = "http://ec2-54-175-128-205.compute-1.amazonaws.com/soapbox-api/"
    ...
    public func getNotifications() -> DataRequest {
        let request = Alamofire.request(BASE_URL + "Ajax_Controller/getNotifications")
        return request
    }
    
    public func getUnreadNotificationCount() -> DataRequest {
        let request = Alamofire.request(BASE_URL + "Ajax_Controller/getUnreadNotificationCount")
        return request
    }
